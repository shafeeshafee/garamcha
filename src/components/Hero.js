...
export const Hero = () => {
	return (
		<div className="lg:flex lg:flex-row md:flex md:flex-col sm:flex sm:flex-col">
			<div className="hero-img h-screen w-full"></div>
			...
			{/* <div className="z-auto h-screen flex flex-col justify-center items-center">
				<h1 className="font-headings drop-shadow text-white lg:text-9xl md:text-7xl sm:text-5xl text-3xl font-bold mb-14">Garamcha</h1>
				<h2 className="font-headings drop-shadow text-white center-content lg:text-3xl md:text-2xl sm:text-1xl text-1xl mb-14">
