		...
		<div>
			<Fade>
				<section className="min-h-screen flex items-stretch text-white font-headings">
					<div className="lg:flex w-5/12 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center signup-image">
						<div className="absolute bg-black opacity-60 inset-0 z-0"></div>
						<div className="w-full px-24 z-10">
							<h1 className="text-5xl font-bold text-left tracking-wide">Organic teas harvested with care.</h1>
					...
					<div className="lg:w-1/2 m-auto w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
						<div className="w-full py-6 z-20">
							...
							<form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
								...
								<div className="py-3">
									<a className="text-black text-lg" href="#down">
										<p>Check out some of our tea below</p>
										<img className="m-auto" src="https://www.svgrepo.com/show/102662/arrow-down-angle.svg" alt="arrow down" />
									</a>
								</div>
				...
				<div className="mt-10 w-3/12 m-auto border border-t-1 border-gray-300"></div>
				<div id="down">
