		...
		<div className="center-content">
			<div className="xl:flex xl:flex-row lg:flex-col">
				<img
					...
					alt=""
				/>
				<p className="center-content text-2xl mx-3">
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem non necessitatibus veniam deleniti id esse ducimus velit aperiam
